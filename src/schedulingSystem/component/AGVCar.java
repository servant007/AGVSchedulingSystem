			...
			if(cardNum != graph.getExecuteCard() && cardNum != graph.getStopCard()){//运行中测试读卡及容错
				if(this.routeCard.size() > 0 ){
					if(cardNum == routeCard.get(0)){
						...
						routeCard.remove(0);
						this.removeCount++;
					}else if(this.routeCard.size() > 1){//读卡异常情况
						if(cardNum == this.routeCard.get(1)){
							...
							if(cardNum == this.routeCard.get(2)){
								...
								logger.error(this.AGVNum + "AGV遗漏"+this.routeCard.get(0));
								logger.debug(this.AGVNum + "AGV遗漏"+this.routeCard.get(0));
								System.out.println(this.AGVNum +"AGV遗漏"+this.routeCard.get(1));
								logger.error(this.AGVNum + "AGV遗漏"+this.routeCard.get(1));
								logger.debug(this.AGVNum + "AGV遗漏"+this.routeCard.get(1));
								//this.playAudio.continuePlay();
								...
								if(cardNum == this.routeCard.get(3)){
									...
									logger.error(this.AGVNum + "AGV遗漏"+this.routeCard.get(1));
									logger.debug(this.AGVNum + "AGV遗漏"+this.routeCard.get(1));
									System.out.println(this.AGVNum +"AGV遗漏"+this.routeCard.get(2));
									logger.error(this.AGVNum + "AGV遗漏"+this.routeCard.get(2));
									logger.debug(this.AGVNum + "AGV遗漏"+this.routeCard.get(2));
									//this.playAudio.continuePlay();
								}else{
